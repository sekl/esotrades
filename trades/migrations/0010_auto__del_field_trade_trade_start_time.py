...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Trade.trade_start_time'
        db.delete_column(u'trades_trade', 'trade_start_time')


    def backwards(self, orm):
        # Adding field 'Trade.trade_start_time'
        db.add_column(u'trades_trade', 'trade_start_time',
